...
MODEL_PATH = r"D:\OCT\retinal-oct-images-classification\code\runs\train\oct_detection11\weights\best.pt"
...
@app.route('/')
def home():
    return send_from_directory(r"D:\OCT\retinal-oct-images-classification\wad\Frontend", 'index copy.html')
